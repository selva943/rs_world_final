-- ULTIMATE FIX: Complete fix for both products and rental_tools
-- This handles ALL schema issues at once
...
-- Step 3: Fix PRODUCTS table completely
DO $$
BEGIN
    -- Add category
    ...
    -- Handle slug column - make it nullable
...
-- Step 4: Fix RENTAL_TOOLS table completely
DO $$
BEGIN
    -- Add rent_per_day column (THIS IS THE MISSING ONE!)
